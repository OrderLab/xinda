...
# setup 1
bash /data/ruiming/xinda/razor-scripts/node_restart/0827.sh a 10000 3_ slow hbase-regionserver restart-slow6-dur10-30-40 slow6 1 hbase-trytry
bash /data/ruiming/xinda/razor-scripts/node_restart/0827.sh a 10000 3_ slow hbase-regionserver norestart-slow6-dur10-30-40 slow6 1 hbase-trytry
# setup 12
bash /data/ruiming/xinda/razor-scripts/node_restart/0827.sh a 10000 3_ slow hbase-regionserver restart-slow6-dur60-30-90 slow6 1 hbase-trytry
bash /data/ruiming/xinda/razor-scripts/node_restart/0827.sh a 10000 3_ slow hbase-regionserver norestart-slow6-dur60-30-90 slow6 1 hbase-trytry
# setup 14
bash /data/ruiming/xinda/razor-scripts/node_restart/0827.sh a 10000 3_ slow hbase-regionserver restart-slow6-dur60-10-70 slow6 1 hbase-trytry
bash /data/ruiming/xinda/razor-scripts/node_restart/0827.sh a 10000 3_ slow hbase-regionserver norestart-slow6-dur60-10-70 slow6 1 hbase-trytry
# setup 15
bash /data/ruiming/xinda/razor-scripts/node_restart/0827.sh e 10000 3_ slow hbase-regionserver restart-slow6-dur60-30-90 slow6 1 hbase-trytry
bash /data/ruiming/xinda/razor-scripts/node_restart/0827.sh e 10000 3_ slow hbase-regionserver norestart-slow6-dur60-30-90 slow6 1 hbase-trytry
# setup 17
bash /data/ruiming/xinda/razor-scripts/node_restart/0827.sh a 10000 3_ slow hbase-regionserver restart-slow3-dur60-30-90 slow3 1 hbase-trytry
bash /data/ruiming/xinda/razor-scripts/node_restart/0827.sh a 10000 3_ slow hbase-regionserver norestart-slow3-dur60-30-90 slow3 1 hbase-trytry

# bash /data/ruiming/xinda/razor-scripts/node_restart/0827.sh a 10000 3_ slow hbase-regionserver restart-slow6-dur5-0-5 slow6 1 test6