...
def balance_tasks_single_system_preferred(tasks, nodes):
    ...
    for task, info in sorted_tasks:
        ...
        while count_remaining > 0:
            ...
            max_count = min(count_remaining, avg_count * 2 if avg_count > 0 else 1)
...
tasks = {
    'cass': {'time': 7, 'count': 50},
    'crdb': {'time': 3.5, 'count': 100},
    'etcd': {'time': 3, 'count': 200},
    'hadoop': {'time': 5, 'count': 200},
    'hbase': {'time': 4.5, 'count': 200},
    'kafka': {'time': 3.3, 'count': 50}
}
num_nodes = 12
