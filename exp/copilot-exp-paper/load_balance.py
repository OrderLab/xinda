...
def balance_tasks_simple(tasks, nodes):
    ...
    total_tasks = tasks['copilot']['count']
    ...
    for i in range(nodes):
        if count_remaining >= tasks_per_node:
            node_assignments[i]['copilot'] = tasks_per_node
        else:
            node_assignments[i]['copilot'] = count_remaining
        node_times[i] = node_assignments[i]['copilot'] * tasks['copilot']['time']
        count_remaining -= node_assignments[i]['copilot']
