...
do
    ...
    do
        ...
        python3 /users/rmlu/workdir/xinda/main.py --sys_name copilot --data_dir test --fault_type nw --fault_location replica1 --fault_duration 120 --fault_severity $sev --fault_start_time 5 --bench_exec_time 60 --benchmark copilot --copilot_concurrency 10 --copilot_scheme $scheme --iter 1 --log_root_dir /users/rmlu/workdir/data/copilot_${scheme}
    done
done